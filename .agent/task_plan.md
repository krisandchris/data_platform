...
- Frontend-only implementation in `agent/TASK-021/frontend/sample-qc-pagination`.
- Update tests for pagination, row layout, and long sample IDs.
- No backend API, dependency, or contract changes.
